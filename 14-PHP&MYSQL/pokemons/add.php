	...
	<div class="col-md-6 offset-md-3">
		...
		<form action="" method="post">
			...
			<div class="form-group">
				...
				<input class="form-control-range" type="range" name="strength" min="0" max="2000" step="5" oninput="ostrength.value=this.value" required>
				<output id="ostrength" class="badge badge-dark"></output>
			</div>
			<div class="form-group">
				<label for="stamina">Resistencia:</label>
				<input class="form-control-range" type="range" name="stamina" min="0" max="2000" step="5" oninput="ostamina.value=this.value" required>
				<output id="ostamina" class="badge badge-dark"></output>
			</div>
			<div class="form-group">
				<label for="speed">Velocidad:</label>
				<input class="form-control-range" type="range" name="speed" min="0" max="2000" step="5" oninput="ospeed.value=this.value" required>
				<output id="ospeed" class="badge badge-dark"></output>
			</div>
			<div class="form-group">
				<label for="accuracy">Precisión:</label>
				<input class="form-control-range" type="range" name="accuracy" min="0" max="2000" step="5" oninput="oaccuracy.value=this.value" required>

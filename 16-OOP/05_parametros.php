...
<head>
	<meta charset="UTF-8">
	<title>Paramétros (Objeto/Obligatorio/Opcional)</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 offset-md-3">
				<h1 class="h3 text-center">Paramétros (Objeto/Obligatorio/Opcional)</h1>
				<hr>
				<?php 
				...
				class FifaWorldCup {
					...
					public function showEvent() {
						...
						echo "<li class='list-group-item'> País: ".$this->country->name."</li>";
